...
.skill .row span:last-child{font-family:'JetBrains Mono',monospace;color:#38bdf8}
...
// 3. STAGE 1: PROJECTS SYNAPSE GRAPH (Multi-Agent Neural Cluster)
...
frame.addEventListener('scroll', () => {
  ...
  else if (progress < 0.65) hud.textContent = "STAGE // 02: CYBERNETIC ARSENAL";
...
function tick(){
  ...
  // Camera glides vertically down through the 3D landmarks
