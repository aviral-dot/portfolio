...
/* ========================================================
   BENTO GRID FLAGSHIP PROJECT CARDS
   ======================================================== */
.bento-project-card {
  position: relative;
  background: linear-gradient(135deg, rgba(10, 16, 30, 0.94) 0%, rgba(5, 8, 18, 0.98) 100%);
  backdrop-filter: blur(30px);
  -webkit-backdrop-filter: blur(30px);
  z-index: 5;
  box-shadow: 0 24px 60px -20px rgba(0, 0, 0, 0.8), inset 0 1px 0 rgba(255, 255, 255, 0.1);
...
.bento-project-card:hover {
  ...
  box-shadow: 0 28px 70px -20px rgba(56, 189, 248, 0.25);
  transform: translateY(-2px);
}

/* Left Column: Core Info & Metrics */
.bento-left {
  display: flex;
...
.bento-metric-val.green { color: #4ade80; }
.bento-metric-val.cyan { color: #38bdf8; }
.bento-metric-val.amber { color: #fbbf24; }
.bento-metric-sub {
  font-size: 0.68rem;
  color: #64748b;
  margin-top: 3px;
...
/* Right Column: Visual Pipeline + Terminal */
.bento-right {
  display: flex;
  flex-direction: column;
  gap: 16px;
...
.pipeline-connector::after {
  ...
  animation: pipePulse 2.4s infinite ease-in-out;
}
@keyframes pipePulse {
  0% { left: -100%; }
  50%, 100% { left: 100%; }
...
.bento-term-logs .log-t { color: #64748b; }
.bento-term-logs .log-info { color: #38bdf8; }
.bento-term-logs .log-ok { color: #4ade80; }
.bento-term-logs .log-warn { color: #fbbf24; }

@media (max-width: 960px) {
  .bento-project-card { grid-template-columns: 1fr; gap: 24px; padding: 24px; }
  .bento-metrics-row { grid-template-columns: repeat(3, 1fr); }
  .pipeline-nodes-track { overflow-x: auto; padding-bottom: 10px; }
}
@media (max-width: 560px) {
  .bento-metrics-row { grid-template-columns: 1fr; }
}
...
<div id="frame">
  ...
  <section id="work">
    ...
    <!-- PROJECT 1: RAGFury -->
    <div class="bento-project-card rv" id="card-ragfury">
      <div class="bento-left">
        <div>
          <div class="bento-badge-row">
            <span class="bento-badge featured">⭐ FEATURED SYSTEM</span>
            <span class="bento-badge status">● PRODUCTION LIVE</span>
          </div>
          <h3>RAGFury — Production Agentic RAG Pipeline</h3>
          <div class="bento-role">Qdrant Cloud · Redis Single-Flight Locking · LangSmith · Groq</div>
          <p class="bento-desc">
            Engineered an agentic RAG system with <b>hybrid sparse/dense vector search &amp; citation-grounded generation</b> over a 600-document index. Built <b>Redis single-flight distributed locking</b> to shield against redundant LLM spikes and enforced <b>4-component DeepEval safety gates</b>.
          </p>
        </div>
        ...
        <div>
          <div class="bento-metrics-row">
            <div class="bento-metric-card">
              <div class="bento-metric-top">⚡ P99 LATENCY</div>
              <div class="bento-metric-val green">2.12s</div>
              <div class="bento-metric-sub">↓ 68% vs baseline</div>
            </div>
            <div class="bento-metric-card">
              <div class="bento-metric-top">📉 INFERENCE COST</div>
              <div class="bento-metric-val cyan">-70%</div>
              <div class="bento-metric-sub">Single-flight caching</div>
            </div>
            <div class="bento-metric-card">
              <div class="bento-metric-top">🛡️ DEFENSE RATE</div>
              <div class="bento-metric-val amber">&gt;95%</div>
              <div class="bento-metric-sub">NeMo injection block</div>
            </div>
          </div>

          <div class="tags">
            <span class="tag hi">Qdrant Cloud</span>
            <span class="tag hi">Redis Locking</span>
          ...
          <div class="bento-actions-row">
            <a href="https://ragfury.streamlit.app/" target="_blank" rel="noopener" class="bento-btn primary">
              <span>Live Demo</span> ↗
            </a>
          </div>
        </div>
        ...
        <div class="bento-pipeline-box">
          <div class="bento-panel-header">
            <div class="bento-panel-title">
              <span class="telemetry-dot"></span> PIPELINE TOPOLOGY (INTERACTIVE)
            </div>
            <button class="bento-panel-btn" onclick="runRagfuryTrace()">
              <span>▶ RUN TRACE</span>
            </button>
          </div>
          <div class="pipeline-nodes-track" id="ragfury-nodes">
            <div class="pipeline-node active" id="rf-n1">
              <div class="node-icon-circle">💬</div>
              <div class="node-label">Prompt</div>
              <div class="node-sub">User Query</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="rf-n2">
              <div class="node-icon-circle">🔍</div>
              <div class="node-label">Qdrant</div>
              <div class="node-sub">Hybrid Search</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="rf-n3">
              <div class="node-icon-circle">🔒</div>
              <div class="node-label">Redlock</div>
              <div class="node-sub">Single-Flight</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="rf-n4">
              <div class="node-icon-circle">🛡️</div>
              <div class="node-label">NeMo</div>
              <div class="node-sub">Guardrails</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="rf-n5">
              <div class="node-icon-circle">⚡</div>
              <div class="node-label">Groq</div>
              <div class="node-sub">Stream LLM</div>
            </div>
          </div>
        </div>

        <!-- Mini Live Trace Terminal -->
        <div class="bento-terminal-box">
          <div class="bento-panel-header">
            <div class="bento-panel-title">
              <span style="color:#38bdf8;">$</span> EXECUTION TELEMETRY TRACE
            </div>
            <span style="font-family:'JetBrains Mono',monospace;font-size:0.65rem;color:#64748b;" id="rf-trace-status">TRACE: READY</span>
          </div>
          <div class="bento-term-logs" id="rf-logs">
            <div><span class="log-t">[12:41:03]</span> <span class="log-info">INFO:</span> Pipeline initialized on FastAPI endpoint</div>
            <div><span class="log-t">[12:41:04]</span> <span class="log-ok">QDRANT:</span> Hybrid search completed in 42ms (top_k=5)</div>
            <div><span class="log-t">[12:41:05]</span> <span class="log-ok">REDIS:</span> Distributed single-flight lock verified</div>
            <div><span class="log-t">[12:41:06]</span> <span class="log-warn">NEMO:</span> Input safety validated (risk_score: 0.01)</div>
            <div><span class="log-t">[12:41:07]</span> <span class="log-ok">GROQ:</span> 740 tokens streamed in 2.12s [200 OK]</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- PROJECT 2: AgentFlow -->
    <div class="bento-project-card rv" id="card-agentflow">
      <div class="bento-left">
        <div>
          <div class="bento-badge-row">
            <span class="bento-badge featured">🤖 MULTI-AGENT ARCHITECTURE</span>
            <span class="bento-badge status">● ZERO STATE CORRUPTION</span>
          </div>
          <h3>AgentFlow — Autonomous Planner-Executor Platform</h3>
          <div class="bento-role">LangGraph · Model Context Protocol (MCP) · FastAPI · NeMo · DeepEval</div>
          <p class="bento-desc">
            Orchestrated <b>3 autonomous workflows</b> (deep research, blog synthesis, transactional email) with human-in-the-loop checkpoints. Integrated <b>2 tool ecosystems (Tavily + Gmail) through MCP</b>, achieving <b>20/20 verified runs</b> with deterministic state graphs.
          </p>
        </div>
        ...
        <div>
          <div class="bento-metrics-row">
            <div class="bento-metric-card">
              <div class="bento-metric-top">⏱️ TIME SLICE</div>
              <div class="bento-metric-val cyan">&lt; 2 min</div>
              <div class="bento-metric-sub">Slashed from 15 min</div>
            </div>
            <div class="bento-metric-card">
              <div class="bento-metric-top">🎯 RELIABILITY</div>
              <div class="bento-metric-val green">20/20</div>
              <div class="bento-metric-sub">Zero state corruption</div>
            </div>
            <div class="bento-metric-card">
              <div class="bento-metric-top">🔗 PROTOCOL</div>
              <div class="bento-metric-val amber">MCP 2.0</div>
              <div class="bento-metric-sub">Tavily + Gmail tools</div>
            </div>
          </div>

          <div class="tags">
            <span class="tag hi">LangGraph</span>
            <span class="tag hi">Model Context Protocol</span>
          ...
          <div class="bento-actions-row">
            <a href="https://agentfloww.streamlit.app/" target="_blank" rel="noopener" class="bento-btn primary">
              <span>Live Demo</span> ↗
            </a>
          </div>
        </div>
      ...
      <div class="bento-right">
        ...
        <div class="bento-pipeline-box">
          <div class="bento-panel-header">
            <div class="bento-panel-title">
              <span class="telemetry-dot"></span> MULTI-AGENT STATE GRAPH
            </div>
            <button class="bento-panel-btn" onclick="runAgentflowTrace()">
              <span>▶ RUN TRACE</span>
            </button>
          </div>
          <div class="pipeline-nodes-track" id="agentflow-nodes">
            <div class="pipeline-node active" id="af-n1">
              <div class="node-icon-circle">📋</div>
              <div class="node-label">Planner</div>
              <div class="node-sub">Decomposition</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="af-n2">
              <div class="node-icon-circle">🌐</div>
              <div class="node-label">MCP Tool</div>
              <div class="node-sub">Tavily Search</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="af-n3">
              <div class="node-icon-circle">👤</div>
              <div class="node-label">Human Gate</div>
              <div class="node-sub">Approval Node</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="af-n4">
              <div class="node-icon-circle">✍️</div>
              <div class="node-label">Writer</div>
              <div class="node-sub">Draft Generator</div>
            </div>
            <div class="pipeline-connector"></div>
            <div class="pipeline-node" id="af-n5">
              <div class="node-icon-circle">📧</div>
              <div class="node-label">MCP Mail</div>
              <div class="node-sub">Gmail Dispatch</div>
            </div>
          </div>
        </div>
        ...
        <div class="bento-terminal-box">
          <div class="bento-panel-header">
            <div class="bento-panel-title">
              <span style="color:#38bdf8;">$</span> AGENT STATE DISPATCH TRACE
            </div>
            <span style="font-family:'JetBrains Mono',monospace;font-size:0.65rem;color:#64748b;" id="af-trace-status">TRACE: READY</span>
          </div>
          <div class="bento-term-logs" id="af-logs">
            <div><span class="log-t">[10:14:20]</span> <span class="log-info">LANGGRAPH:</span> Initializing StateGraph with MemorySaver checkpoint</div>
            <div><span class="log-t">[10:14:22]</span> <span class="log-ok">MCP_BRIDGE:</span> Executing Tavily query: 5 sources retrieved</div>
            <div><span class="log-t">[10:14:25]</span> <span class="log-warn">INTERRUPT:</span> Human approval requested at draft node</div>
            <div><span class="log-t">[10:14:27]</span> <span class="log-ok">APPROVED:</span> Human-in-the-loop validated output</div>
            <div><span class="log-t">[10:14:29]</span> <span class="log-ok">MCP_GMAIL:</span> Draft email dispatched with zero corruption</div>
          </div>
        </div>
      </div>
    </div>
...
projectCluster.position.set(4.2, -4.8, -4.0);
const clusterNodes = [];
for (let i = 0; i < 8; i++) {
...
/* ========================================================
   BENTO INTERACTIVE PIPELINE TRACE RUNNERS
   ======================================================== */
function runRagfuryTrace() {
  playMechanicalClick(800, false);
  const statusEl = document.getElementById('rf-trace-status');
  const logsEl = document.getElementById('rf-logs');
  const nodes = [
    document.getElementById('rf-n1'),
    document.getElementById('rf-n2'),
    document.getElementById('rf-n3'),
    document.getElementById('rf-n4'),
    document.getElementById('rf-n5')
  ];
  ...
  const traceSteps = [
    { text: 'INFO: Received query on /v1/chat endpoint', time: '00:00.010', type: 'log-info', node: 0 },
    { text: 'QDRANT: Hybrid sparse/dense search -> 5 chunks in 38ms', time: '00:00.048', type: 'log-ok', node: 1 },
    { text: 'REDIS: Redlock acquired -> single-flight lock OK', time: '00:00.062', type: 'log-ok', node: 2 },
    { text: 'NEMO: Safety pass -> 0 jailbreaks (confidence: 0.99)', time: '00:00.088', type: 'log-warn', node: 3 },
    { text: 'GROQ: LLM token stream complete (2.12s total latency)', time: '00:02.120', type: 'log-ok', node: 4 }
  ];
  ...
  traceSteps.forEach((step, idx) => {
    setTimeout(() => {
      ...
      playMechanicalClick(600 + idx * 80, true);

      const d = document.createElement('div');
      d.innerHTML = `<span class="log-t">[${step.time}]</span> <span class="${step.type}">${step.text}</span>`;
      logsEl.appendChild(d);
      logsEl.scrollTop = logsEl.scrollHeight;

      if (idx === traceSteps.length - 1) {
        statusEl.textContent = 'COMPLETED (200 OK)';
...
function runAgentflowTrace() {
  playMechanicalClick(750, false);
  const statusEl = document.getElementById('af-trace-status');
  const logsEl = document.getElementById('af-logs');
  const nodes = [
    document.getElementById('af-n1'),
    document.getElementById('af-n2'),
    document.getElementById('af-n3'),
    document.getElementById('af-n4'),
    document.getElementById('af-n5')
  ];
  ...
  const traceSteps = [
    { text: 'PLANNER: LangGraph decomposes goal into 3 sub-tasks', time: '00:00.020', type: 'log-info', node: 0 },
    { text: 'MCP_BRIDGE: Tavily tool invoked via JSON-RPC stream', time: '00:00.320', type: 'log-ok', node: 1 },
    { text: 'HUMAN_GATE: Checkpoint reached, reviewer signed off', time: '00:00.640', type: 'log-warn', node: 2 },
    { text: 'WRITER: Markdown draft generated with strict citations', time: '00:01.050', type: 'log-ok', node: 3 },
    { text: 'MCP_GMAIL: Email dispatched, zero state corruption verified', time: '00:01.450', type: 'log-ok', node: 4 }
  ];
  ...
  traceSteps.forEach((step, idx) => {
    setTimeout(() => {
      nodes.forEach(n => n.classList.remove('active'));
      if (nodes[step.node]) nodes[step.node].classList.add('active');
      playMechanicalClick(550 + idx * 90, true);
      ...
      if (idx === traceSteps.length - 1) {
        statusEl.textContent = 'GRAPH COMPLETED';
        statusEl.style.color = '#4ade80';
      }
    }, idx * 450);
  });
...
#           <div class="bento-actions-row">
#             <a href="https://github.com/aviralbharti832002" target="_blank" class="bento-btn primary">
#               <span>View Source</span> ↗
#             </a>
#             <a href="#contact" class="bento-btn secondary">
